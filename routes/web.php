...
Route::get('/conteudo/listar', 'ConteudoController@listar')->name('conteudo.listar');
Route::get('/conteudo/listar/{id}', 'ConteudoController@listar_por_id')->name('conteudo.listar.id');
